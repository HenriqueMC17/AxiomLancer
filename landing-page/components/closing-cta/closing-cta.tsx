...
export function ClosingCta() {
  return (
    <section id="conversao" className="py-24 bg-dark-l0 relative overflow-hidden border-t border-white/5 scroll-mt-20">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        
        <div className="rounded-3xl border border-emerald-500/30 bg-dark-l1 p-8 sm:p-14 shadow-2xl relative">
          <div 
            aria-hidden="true" 
            className="pointer-events-none absolute inset-0 bg-radial from-growth-emerald/10 to-transparent blur-2xl" 
          />
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
            <a
              href="#trial"
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-xl bg-growth-emerald hover:bg-[#256629] px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-growth-emerald/20 transition-[background-color,transform] duration-150 active:scale-98 outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
            >
